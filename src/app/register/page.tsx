  ...
  return (
    <PageTransition>
      <Wrapper className="flex items-center justify-center">
        <div className="max-w-xl md:max-w-xl w-full bg-gray-100 dark:bg-gray-900/60 backdrop-blur-md border border-gray-300 dark:border-gray-700 rounded-2xl p-8 shadow-2xl">
