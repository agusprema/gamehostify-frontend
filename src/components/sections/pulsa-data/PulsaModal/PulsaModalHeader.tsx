  ...
  return (
    <div className="flex items-start gap-4 mb-6">
      ...
      <div className="flex-1 min-w-0">
        ...
        {selectedPkg && (
          <div className="mt-2 inline-block rounded-md bg-primary-500/10 border border-primary-400/30 px-2 py-1 text-xs font-medium text-primary-600 dark:text-primary-300">
