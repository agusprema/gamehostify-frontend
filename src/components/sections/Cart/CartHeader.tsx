...
const CartHeader = React.memo(function CartHeader({ quantity, onClose }: CartHeaderProps) {
  return (
    <header className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700/70 bg-white dark:bg-gray-900/60 transition-colors">
