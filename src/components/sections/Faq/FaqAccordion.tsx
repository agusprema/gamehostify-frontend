...
export default function FaqAccordion({ items }: { items: FaqItem[] }) {
  ...
  return (
    <div className="divide-y divide-gray-200 dark:divide-gray-700 rounded-xl border border-gray-200 dark:border-gray-700 bg-white/70 dark:bg-gray-900/60 backdrop-blur-md shadow-sm">
      {items.map((it, i) => (
        <div key={i}>
          <button
            type="button"
